...
def update():
    ...
    os.system("cd .. && rm -rf DRUNKBomber && git clone https://github.com/Toxic-Noob/ToxicBomber > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd DRUNKBomber && python Dbomb.py")
...
def logo():
    ...
    print("\033[94m│     \033[92mЯƎᙠMOᙠ⋊ͶUЯᗡ

D̷̝̙̱̠͖̈́̍͋̏̓́̾͝R̵̞̦̩̲̖̈ͅŨ̴̳̲̹͙̣̈́̓̔͂N̵̡̧͔̫̹͋̌͆̊́̃̕͝ͅK̶͎̆̿́̂̅B̷̢̺̳̮̻̰̤̅̂͜Ȏ̷̗͕͈̲̞̑̑̂̒̇̒͝M̶̡̛̹̲͇̩͇̭̍͂̍̃͗͠ͅB̸̥̹̱̘̦͍̎ͅE̷̻͈͓̞͚͖̻͖̗̳͝R̴̮͇̬̰̝̹̣̹̺̎̑̕͠

🅳🆁🆄🅽🅺🅱🅾🅼🅱🅴🆁  \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : DRUNK01                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/DRUNK01 \033[94m│".center(columns+9))
